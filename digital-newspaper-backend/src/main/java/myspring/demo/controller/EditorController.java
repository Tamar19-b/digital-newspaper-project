...
@RestController
@RequestMapping("/Editors") //דרך הכתובת הזו תהיה הגישה לכל הפונקציות במחלקה
public class EditorController {
    ...
    public List<EditorDTO> getAllEditors(){
        Type t=new TypeToken<List<EditorDTO>>(){}.getType();//באופן זה מוגדר הסוג הנכון אליו תתבצע ההמרה של רשימה שלימה
